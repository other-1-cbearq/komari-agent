...
resolve_snapshot_version() {
    snapshot_api_url="https://api.github.com/repos/other-1-cbearq/komari-agent/releases?per_page=100"
...
if [ -n "$github_proxy" ]; then
    ...
    download_url="${github_proxy}/https://github.com/other-1-cbearq/komari-agent/releases/${download_path}/${file_name}"
else
    # Direct access to GitHub releases
    download_url="https://github.com/other-1-cbearq/komari-agent/releases/${download_path}/${file_name}"
fi
